...
<!--
 ...
 -->
		...
		<div id="instr_content">
			<p>
				O pagamento deste boleto também poderár efetuado 
...
do Sacado</b></div></TD></tr></tbody></table>
		...
		<tr class="campos">
			...
			<td class="valor_cobrado" style="text-align: right;"><?php echo $dadosboleto["valor_boleto"]?></td>
		</tr>
		</tbody>
		</table>
		...
		<tr><td class="last_line">
			...
			<tr class="campos">
				<td class="valor_cobrado2" style="text-align: right;"><?php echo $dadosboleto["valor_boleto"]?></td>
			</tr>
			</tbody>
			</table>
		</td></tr>
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0><TBODY><TR><TD width=666 align=right ><font style="font-size: 10px;">Autenticação mecânica - Ficha de Compensa/font></TD></tr></tbody></table>
		<div class="barcode">
